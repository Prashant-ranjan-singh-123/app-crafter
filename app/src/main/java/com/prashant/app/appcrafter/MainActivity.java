package com.prashant.app.appcrafter;
...
public class MainActivity extends AppCompatActivity {
        ...
        public void print() {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(com.prashant.app.appcrafter.MainActivity.this, "Printing...", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( ! com.prashant.app.appcrafter.CheckNetwork.isInternetAvailable(this)) //returns true if internet available
        {
            //if there is no internet do this
//            setContentView(R.layout.activity_main);
            Intent nointernet=new Intent(com.prashant.app.appcrafter.MainActivity.this,noInternet.class);
...
//            webview.getSettings().setJavaScriptEnabled(true);
            ...
            webview.setWebViewClient(new com.prashant.app.appcrafter.MainActivity.WebViewClientDemo());
...
// Add any other necessary settings for printing
            ...
            webview.setWebViewClient(new WebViewClient() {
                ...
                public boolean shouldOverrideUrlLoading(WebView view, String url) {
                    ...
                    if(!com.prashant.app.appcrafter.CheckNetwork.isInternetAvailable(getBaseContext())) {

                        Intent intent = new Intent(com.prashant.app.appcrafter.MainActivity.this, noInternet.class);
                        startActivity(intent);
                    }
                    else {
                        webview.reload();
        ...
        webview.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, WebChromeClient.FileChooserParams fileChooserParams) {
                ...
                try {
                    ...
                    Toast.makeText(com.prashant.app.appcrafter.MainActivity.this, "Cannot open file chooser", Toast.LENGTH_SHORT).show();
                    return false;
                }
                return true;
            }
...
//        ImageView btnClose = dialog.findViewById(R.id.btn_close);
    ...
    // I editted to here (Part 2)

}

class CheckNetwork {

    private static final  String TAG = com.prashant.app.appcrafter.CheckNetwork.class.getSimpleName();
